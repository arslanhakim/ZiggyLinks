    ...
    <PublicLayout>
      ...
      <section className="about-hero">
        ...
        <div className="about-hero__image">
          <ImagePlaceholder src="/images/studio/studio-04.webp" name="Abena Asante" detail="Founder" className="about-hero__img" />
        </div>
      </section>
        ...
        <div className="container about-origin__grid">
          ...
          <div className="about-origin__images">
            <div className="origin-img origin-img--top">
              <ImagePlaceholder src="/images/studio/studio-02.webp" name="Studio interior" detail="East Cantonments, Accra" />
            </div>
            <div className="origin-img origin-img--bottom">
              <ImagePlaceholder src="/images/studio/weld-process-01.webp" name="The weld moment" detail="Micro-weld process" />
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section about-team">
        <div className="container">
          ...
          <div className="team-grid">
            {[
              { name: 'Abena Asante', role: 'Founder & Lead Jeweller', bio: 'Trained in permanent jewellery welding in London. Obsessed with details, materials, and making clients feel seen.', img: '/images/studio/studio-01.webp' },
              { name: 'Kofi Mensah', role: 'Studio Assistant & Client Experience', bio: 'Kofi handles bookings, client care, and makes sure the studio is always a calm, welcoming place to spend an hour.', img: '/images/studio/studio-03.webp' },
            ].map(person => (
